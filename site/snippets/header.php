...
<!-- ── Visitor header (currently unused: project pages render the full
     site header below). Kept as a minimal fallback. ─────────────────── -->
<header class="visitor-header sticky top-0 z-50 bg-white">
  <div class="visitor-header__inner">
    ...
    <a class="visitor-header__cta no-underline" href="<?= url('map') ?>">
